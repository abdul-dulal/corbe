...
import Solutions from "@/src/components/ui/Solutions";
          ...
          >
            {categories.map((category) => (
              <button
                ...
                className={`relative px-[30px] py-4 z-[9] border border-solid border-light rounded-[99px] text-[17px] leading-[15px] font-medium text-light capitalize hover:text-white duration-500 transition-all ${
          ...
          <div className="grid gap-12">
            {projects
              ...
              .map((project) => (
                <div
                  key={project.id}
                  className="grid lg:grid-cols-2 xl:gap-[60px] gap-12 items-center sm:p-10 p-4 border border-solid border-light transition-all duration-700 ease-out"
                >
                  <div className="relative overflow-hidden" data-aos="zoom-in">
                    <Image
                      src={project.image}
                      alt={project.title}
                      className="w-full transition-transform duration-500 ease-in-out transform hover:scale-105"
                    />
                  </div>
                  <div data-aos="zoom-in">
                    <h3 className="sm:lg:text-[28px] sm:text-2xl text-xl text-secondary leading-[40px] font-bold mb-[30px]">
                      {project.title}
                    </h3>
