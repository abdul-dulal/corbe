            ...
            <div className="relative">
              ...
              <div>
                ...
                <blockquote className="md:p-[60px] p-6 bg-white rounded-[15px]">
                  <h5 className="lg:text-xl md:text-lg text-base leading-[26px] font-bold mb-[30px]">
              ...
              <div>
                ...
                <p className="text-light my-5">
                  ...
                  fact that a reader <br /> will be distrolr acted laoreet
                  Aliquam reader will be distrol acted ished fact <br /> that a
                  reader will be distrol ds shem acted bioii the.ished fact that
                  a reader <br /> will Design done a facatory
                </p>
