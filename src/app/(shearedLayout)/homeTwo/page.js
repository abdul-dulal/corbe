          ...
          <div className="grid grid-cols-12 justify-between 2xl:gap-[129px] lg:gap-[100px] gap-0  mt-[100px]">
            ...
            <div className="lg:col-span-4 col-span-12 ">
              <div className="lg:block flex flex-wrap justify-between lg:mt-0 mt-10">
                ...
                <button className=" group relative z-20  block mb-[46px]  py-[22px] px-8 bg-primary  after:absolute after:content-['']  after:h-full after:left-[50%] after:top-0 after:w-0 after:transition-all after:duration-500 after:bg-[#083C2F] after:-z-[1]  after:hover:right-[50%] after:hover:left-0 after:hover:w-[100%]">
                  <Link
                    href="/"
