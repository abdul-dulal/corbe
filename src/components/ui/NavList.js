  ...
  return (
    <div>
      <ul className={`lg:flex  gap-10 text-${listColor} hidden`}>
        <li className="pt-5 pb-6 relative">
          <Link href="" className="duration-500 hover:text-primary">
            Home
          </Link>
          <ul className="sub_menu bg-[#083C2F] rounded-sm w-[250px] z-[9] text-left py-4 mt-12 px-5 block -left-[25px] m-auto absolute invisible opacity-0  transition-all duration-500 ease-out origin-top-left transform ">
